...
<p>Indulge in the velvety texture and delicious taste of our Grapes Bliss Smoothie, packed with: <br /> </p>
- Fresh grapes for healthy fats and creamy texture <br />
...
<Link href={"/second-page"} className=" purple flex justify-center mt-3 text-xl pt-2  pb-2 mr-20 ml-20 text-white rounded-md transition duration-300"> <button className="">Back On Smoothies</button></Link>
